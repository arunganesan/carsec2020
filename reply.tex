...
{\large \textbf{Asked/commented by}}
\begin{itemize}
...
{\large \textbf{How we addressed}} 
\begin{itemize}
    \item \changes{The novelty of our system is primarily \underline{using smartphone sensing for falsification detection} which, despite its importance, was never addressed before}
    ...
    \item \changes{All of these have now been clarified in the Introduction and in the Key Findings.}
