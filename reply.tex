...
\begin{itemize}
    ...
    \item Reviewer 4:  {\it ...The lack of novelty makes this paper less attractive to the IMWUT community. ... If the authors consider a resubmission, it would be interesting to see new approaches for sensing data processing, a comprehensive design and evaluation of the car’s sensor cross-validation system, and insights about the involving smartphones into car security system.}
\end{itemize}
