...
filter, neural network), we have built a system that is robust to common phone usage/movements. We demonstrate this through extensive experiments.}
...
\item \changes{{\em Expansion of vehicle estimation research}. We extend prior work on vehicle estimation by (a) developing a novel neural-network based gear-estimation algorithm and (b) investigating the failure modes of engine RPM estimation using prior methods.}
