...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        ...
        actual value.}
    \end{subfigure}
    \caption{The true positive rate (TPR) and false positive rate (FPR) of different conditions. {\color{highlightColor} The legends are consolidated for simplicity. The black and gray lines are
...
can be summarized as follows.  {\color{highlightColor}These findings
