...
\changes{We corroborated the error values reported in prior literature in estimating vehicle sensors \cite{liu_bigroad:_2017, cho_cps_2015}. In addition to this, we discovered three key findings from our work, summarized below.}

\begin{itemize}
    \item \changes{Phone estimation algorithms work reliably even while the phone is being used for common activities such as texting or making a phone call.}
