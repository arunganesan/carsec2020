...
{\caption{The left figure shows TPR for varying amounts of injection magnitude. The right figure shows varying \textit{fixed} values of injection. For all cases, FPR was less than 5\% and therefore omitted. Figure best seen in color.}\label{fig:smallest-magnitude-injection}}
%\Description[Detection accuracy for varying injection magnitude]{Detection accuracy for varying magnitudes of injection. Compared for both increasing delta injection and increasing fixed-value injection.}
\vspace{-0.1in}
\end{figure}
