...
We expect the driver to connectplug their phone in the car power source, as is commonly the case. A security-conscious driver may be willing to make this tradeoff to avoid any battery consumption by \watchfone.
