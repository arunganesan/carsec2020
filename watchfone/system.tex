...
{\color{highlightColor}Some of these sensor estimations require {\em per-vehicle} calibration. For example, we 
...
vehicle model and can be done by the OEM before release.}
...
{\color{highlightColor}We estimate the steering wheel angle (SWA) using the yaw-rate of the gyroscope on the phone. 
